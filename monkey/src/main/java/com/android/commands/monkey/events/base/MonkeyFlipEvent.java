...
public class MonkeyFlipEvent extends MonkeyEvent {
    ...
    private static final byte[] FLIP_0 = {0x7f, 0x06, 0x00, 0x00, (byte) 0xe0, 0x39, 0x01, 0x00, 0x05, 0x00, 0x00,
            0x00, 0x01, 0x00, 0x00, 0x00};

    private static final byte[] FLIP_1 = {(byte) 0x85, 0x06, 0x00, 0x00, (byte) 0x9f, (byte) 0xa5, 0x0c, 0x00, 0x05,
    ...
    public int injectEvent(IWindowManager iwm, IActivityManager iam, int verbose) {
        if (verbose > 0) {
            Logger.println("Sending Flip keyboardOpen=" + mKeyboardOpen);
        }
        ...
        try {
            ...
            Logger.warningPrintln("Got IOException performing flip" + e);
